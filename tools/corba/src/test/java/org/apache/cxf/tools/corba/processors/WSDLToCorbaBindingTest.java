...
public class WSDLToCorbaBindingTest {
    ...
    private void getStringAttributeTest(Binding binding) {
        BindingOperation bindingOp = binding.getBindingOperation("_get_string_attribute", "_get_string_attribute",
    ...
    private void assertMixedArraysMappingDifficultSequences(CorbaTypeMap typeMap) {
        ...
        // p9 is unwrapped, so there's
        // "MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequenceArray" type
        // registered and "MixedArrayType.p9-anonymous-unwrapped-non-primitive-sequence"
        // as type of the element
        // which is Struct
        ...
        // p10 is wrapped, so there's no
        // "MixedArrayType.p10-anonymous-wrapped-non-primitive-sequenceArray"
