...
public class UriInfoImplTest {
    ...
    public void testRelativizeChild() throws Exception {
         ...
         *
         * <br/>
         * <b>Request URI:</b> <tt>http://host:port/app/root/a/b/c</tt>
         * <br/>
         * <b>Supplied URI:</b> <tt>a/b/c/d/e</tt>
         * <br/>
         * <b>Returned URI:</b> <tt>d/e</tt>
         *
         * NOTE: Although the above is correct JAX-RS API-wise (as of 2013-04-21),
         * it is WRONG URI-wise (but correct API wise)
         * as the request URI is missing the trailing / -- if the request returned HTML
         * at
         * that location, then resolving "d/e" would end up instead at /app/root/a/b/d/e
         * -- see URI.create("/app/root/a/b/c").resolve("d/e"). Therefore the below
         * tests
         * use the slightly modified request URI http://example.com/app/root/a/b/c/ with
         * a trailing /
         *
